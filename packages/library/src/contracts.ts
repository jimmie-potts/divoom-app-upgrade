...
export type LibraryErrorCode='invalid-input'|'not-found'|'revision-conflict'|'asset-referenced'|'busy'|'closed'|'migration-error'|'database-error'|'cleanup-pending'|'storage-error'|'catalog-corrupt';
