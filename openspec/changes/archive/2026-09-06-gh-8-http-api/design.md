...
- Normal startup disables diagnostic fake-adapter recording. Test fixtures retain the default recording behavior. This prevents repeated playback from accumulating RGB buffers without altering writer timing or cancellation.
