...
Keep a local Pixoo library recoverable and make native simulator startup and
...
The backend SHALL expose loopback diagnostics for uptime, simulator mode,
...
media SHALL NOT be discarded as a cache. Trace: issue #10 startup criterion.
