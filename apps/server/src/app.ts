...
export function createApp(options:AppOptions={}) {
  if(options.monitorEnabled&&!options.dataDir)throw new Error('Monitoring requires private runtime storage');
  ...
  security(app,options.authenticate,options.mcpEnabled);
